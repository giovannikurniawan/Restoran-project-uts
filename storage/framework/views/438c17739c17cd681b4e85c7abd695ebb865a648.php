                ...
                <ul class="list-unstyled">
                  <li class="media">
                    ...
                    <div class="media-body">
                      <h5 class="mt-2 mb-1">Ivana Angela</h5>
                  ...
                  <li class="media">
                    ...
                    />
                    <div class="media-body">
                      <h5 class="mt-2 mb-1">Kezia Cindy Tricia</h5>
                  ...
                  <li class="media">
                    ...
                    />
                    <div class="media-body">
                      <h5 class="mt-2 mb-1">Stephanie Liem</h5>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\UTSIF430Restaurant-Laravel\resources\views/pages/detail.blade.php ENDPATH**/ ?>