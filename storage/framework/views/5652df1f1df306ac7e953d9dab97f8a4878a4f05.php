            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto d-none d-lg-flex">
                <li class="nav-item dropdown">
                  ...
                  >
                    <img
                      src="/images/icon-saya.png"
                      alt=""
                      class="rounded-circle mr-2 profile-picture"
                    />
                    Hi, Giovanni Kurniawan (00000028665)
                  </a>
              ...
              <ul class="navbar-nav d-block d-lg-none mt-3">
                <li class="nav-item">
                  <a class="nav-link" href="#"> Hi, Giovanni Kurniawan (00000028665)</a>
                </li>
                <li class="nav-item">
...
<?php /**PATH C:\laragon\www\UTSIF430Restaurant-Laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>